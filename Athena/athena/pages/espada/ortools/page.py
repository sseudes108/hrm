...
from athena.core import athena, helper
from athena.core.calculadora import page as calculadora
from athena.pages.espada.ortools.charts import graficos_block
from athena.pages.espada.ortools.analistas_block import layout as analistas_block
...
def render(context):
    """Renderiza a capacidade usando o payload fornecido pela sidebar fixa."""
