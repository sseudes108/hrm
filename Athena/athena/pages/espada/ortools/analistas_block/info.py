...
def _draw_component(df_escala: pd.DataFrame, payload):
    ...
    html_info = f"""
    <div style="color: var(--ui-colors-text); font-size: 0.95em; line-height: 2; padding: 0.2rem 0;">
        <div>
            <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">Total Analistas:</span>
            <span style="font-weight: 700; margin-left: 6px; color: var(--ui-colors-primary);">{total_analistas}</span>
        </div>
        <div>
            <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">Capacidade Total:</span>
            <span style="font-weight: 700; margin-left: 6px;">{str_cap_total} propostas</span>
        </div>
        <div>
            <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">Média / Hora:</span>
        ...
        <div style="display: flex; gap: 8px;">
            <div>
                <div>
                    <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">1ª Entrada:</span>
                    <span style="font-weight: 700; margin-left: 6px;">{primeira_entrada}</span>
                </div>
                <div>
                    <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">Últ. Entrada:</span>
                    <span style="font-weight: 700; margin-left: 6px;">{ultima_entrada}</span>
                </div>
            </div>
            <div>
                <div>
                    <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">1ª Saída:</span>
                    <span style="font-weight: 700; margin-left: 6px;">{primeira_saida}</span>
                </div>
                <div>
                    <span style="color: var(--ui-colors-text-muted); font-size: 0.81em; font-weight: 600; text-transform: uppercase;">Últ. Saída:</span>
