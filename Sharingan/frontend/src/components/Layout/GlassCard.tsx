...
export function GlassCard({ children, className = "" }: GlassCardProps) {
  ...
  const dynamicGlassStyle = {
    ...
    border: `2px solid ${theme.primary}22`, // O '22' no final adiciona transparência à borda
    
    // 3. O SEU BLUR E FUNDO
    backdropFilter: 'blur(6px) saturate(1.1)',
    backgroundColor: 'rgba(10, 15, 26, 0.14)',
    
    // 4. EXTRA: Um brilho externo sutil para combinar com o "mood" do sistema
    boxShadow: `0 8px 32px 0 rgba(0, 0, 0, 0.37), inset 0 0 1px 1px ${theme.primary}11`,
